...
//   e.preventDefault();
//   const username = e.target.username.value; // Get the username from the input field
...
// ipcRenderer.on("websocket-connection", (event, websocket) => {
//   ws = websocket;

//   ws.onopen = () => {
//     console.log("Connected to the server, sending username...");
//   };
